...
class Validation
{
    ...
    public static double ValidateNumber(System.Globalization.CultureInfo culture, object obj, double? lowerBound = null, double? upperBound = null)
    {
        if (!IsValidDouble(obj)) return lowerBound.HasValue ? lowerBound.Value : 0.0;
        
        double value = Convert.ToDouble(obj.ToString(), culture);
    ...
    public static bool IsValidRange(System.Globalization.CultureInfo culture, object obj, double? lowerBound = null, double? upperBound = null, bool showMsgBox = false, System.Windows.Forms.Form? parent = null)
    {
        if (!IsValidDouble(obj))
        {
            if (showMsgBox && parent is not null)
            {
